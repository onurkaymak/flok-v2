...
const people = [
  {
    id: 1,
    name: "Auto Detailer",
    avatar: "https://i.ibb.co/J2t8rb4/cleaning.png",
  },
  {
    id: 2,
    name: "Customer Service Agent",
    avatar: "https://i.ibb.co/34bsw2G/car-rent.png",
  },
  {
    id: 3,
    name: "Manager",
    avatar: "https://i.ibb.co/n7zmdJB/project-management.png",
  },
];
...
const SignUpForm = ({ onCreateAccount }: Props) => {
  ...
  const formSubmitHandler = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const userInfo: CreateUserInfo = {
      ...
      enteredPassword: passInputRef.current.value,
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form
        className="mx-auto mt-16 max-w-sm sm:mt-20 group"
